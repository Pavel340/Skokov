	...
	$.fn.extend({ 
		infiniteCarousel: function(options)
		{
			...
			var options = $.extend(defaults, options);
				...
				$(obj).append('<div class="ic_left_nav" style="position:absolute;left:0;width:46px;top:'+(heightSource/2-16)+'px;">').append('<div class="ic_right_nav" style="position:absolute;width:46px;right:0;top:'+(heightSource/2-16)+'px;">');
